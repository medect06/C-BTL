...
void themNguyenLieu(vector<NguyenLieu>& danhSach, const NguyenLieu& nguyenLieuMoi); //Thêm nguyên liệu vào danh sách
void hienThiKho(const vector<NguyenLieu>& danhSach); //Hiển thị danh sách nguyên liệu trong kho
void layNguyenLieu(vector<NguyenLieu>& danhSach, const NguyenLieu& nlSuDung, int soMon); //Lấy nguyên liệu từ kho để sử dụng
